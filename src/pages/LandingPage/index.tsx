    ...
    <section className="lp__bottom__wrapper">
      <div className="donation__wrapper">
        ...
        <p className="donation-text">
          ...
          the good old days. By coming together and celebrating program history
          from past to present, there will always be one thing that joins us
          together - rowing.
        </p>
        {/* Put this back later */}
      ...
      <section className="lp__middle__wrapper">
        <div className="middle_header__wrapper">
          ...
          <p className="middle-content__text">
            ...
            can train, grow, and represent the university in intercollegiate
            competition.
          </p>
        </div>
        <div className="middle_imgs__wrapper">
          <div className="middle_img__wrapper">
            ...
            <p className="img__text">
              2016 Dad Vail Lightweight Eight Champions: Jonas Weller, Nemanja
              Uzanovic, Zackary Ghalayini, Johnathan Blazevic, Galen Bernick,
              Christopher Gough, Milos Veres, Nemanja Matijevic
            </p>
          </div>
          <div className="middle_img__wrapper">
